    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      <aside className="admin-sidebar" style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <ul style={{ flex: 1, listStyle: 'none', padding: 0 }}>
          ...
          <li style={{ marginBottom: '10px' }}><Link to="/admin/modules" style={{ color: 'var(--text-main)', textDecoration: 'none' }}>Add Modules</Link></li>
          <li style={{ marginBottom: '10px' }}><Link to="/admin/view-modules" style={{ color: 'var(--text-main)', textDecoration: 'none' }}>View & Delete Modules</Link></li>
        </ul>
